...
//
// ★ 관측 층 분리(tdd §7.5): 이 파일은 **구조만** 문다. "재생성이 실제로 캐시를 낸다" 는 기능 축은
//   `summary.generator.test.mjs`(GN3)·`summary.cli-exit.test.mjs`(XC1·XC7)·`feeds.verify.test.mjs`(FR1)
//   가 이미 문다 — 그 셋이 IG 의 **짝 가드**다(tdd §3.2). REFACTOR 때 "IG 와 무관" 이라며 지우지 말 것.
